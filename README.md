This is a poorly thought test of NextJS which simulates an Online version of the board game *World Domination* . It is using Github OAuth for Auth and Postgresql as a store of data. 
